...
<div class="container">
    ...
    <form method="get" class="row g-2 mb-3">
        <div class="col-md-4">
            <input type="text" name="q" value="{{ $q ?? '' }}" class="form-control" placeholder="Cari WERKS/AUART/Deskripsi">
        </div>
        <div class="col-md-2">
        ...
        <table class="table table-hover table-sm align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('mapping.edit',$row->Id) }}" class="btn btn-sm btn-edit">Edit</a>
