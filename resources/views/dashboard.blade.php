        ...
        @if ($view === 'so' && !empty($chartData))
                ...
                @if (!empty($chartData['due_this_week']))
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-lg-4">
                            <div class="card shadow-sm h-100 yz-chart-card">
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fas fa-user-clock me-2"></i>Customers Due This Week
                                    </h5>
                                    <hr class="mt-2">
                ...
                <div class="col-lg-7">
                    <div class="card shadow-sm h-100 yz-chart-card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><i class="fas fa-chart-column me-2"></i>Value to Pacing vs Overdue by
                                Location</h5>
                            <hr class="mt-2">
            ...
            <div class="row g-4 mb-4">
                <div class="col-12">
                    <div class="card shadow-sm h-100 yz-chart-card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-primary-emphasis"><i class="fas fa-crown me-2"></i>Top 5 Customers
                                by Value of Overdue Orders Awaiting Packing</h5>
                            <hr class="mt-2">
        ...
        @else
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-7">
                    <div class="card shadow-sm h-100 yz-chart-card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><i class="fas fa-chart-column me-2"></i>Outstanding Value by Location
                            </h5>
                            <hr class="mt-2">
                            <div class="chart-container flex-grow-1">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-6">
                    <div class="card shadow-sm h-100 yz-chart-card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-primary-emphasis"><i class="fas fa-crown me-2"></i>Top 4 Customer
                                with the most Outstanding value</h5>
                            <hr class="mt-2">
                            <div class="chart-container flex-grow-1">
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm h-100 yz-chart-card">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-danger-emphasis"><i
                                    class="fas fa-triangle-exclamation me-2"></i>Top 4 Customers with Most Overdue PO</h5>
                            <hr class="mt-2">
                            <div class="chart-container flex-grow-1">
    ...
    <div class="d-flex align-items-center justify-content-center h-100 p-3 text-muted" style="min-height:300px;">
      ...
      `).join('');
              ...
              <i class="fas fa-exclamation-triangle me-2"></i>${e.message}
                ...
                if (ctxLocationStatus) {
                    ...
                    if (locationData.length === 0) {
                        ...
                        const onTime = labels.map(loc => (locationData.find(d => d.location === loc)?.on_time_value ||
                            0));
                        const overdue = labels.map(loc => (locationData.find(d => d.location === loc)?.overdue_value ||
                            0));
                            ...
                            options: {
                                ...
                                plugins: {
                                    tooltip: {
                                        callbacks: {
                                            label: (ctx) =>
                                                `${ctx.dataset.label}: ${formatFullCurrency(Number(ctx.raw) || 0, 'USD')}`
                                        }
                                    }
                                }
                            }
                ...
                createHorizontalBarChart('chartTopCustomersValueSO', topCustomerData, 'total_value',
        ...
        <tr class="js-remark-row" data-url="${url.toString()}">
                    ...
                    new Chart(ctxLocation, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                backgroundColor: currencyToDisplay === 'IDR' ?
                                    'rgba(25, 135, 84, 0.6)' : 'rgba(54, 162, 235, 0.6)',
                                borderColor: currencyToDisplay === 'IDR' ? 'rgba(25, 135, 84, 1)' :
                                    'rgba(54, 162, 235, 1)',
                                borderWidth: 1,
                                borderRadius: 5
                            }]
            ...
            const topValueTitle = document.querySelector('#chartTopCustomersValue')?.closest('.card')?.querySelector(
                '.card-title');
            if (dataHolder.dataset.selectedType === 'lokal') {
                if (topValueTitle) topValueTitle.innerHTML =
                    `<i class="fas fa-crown me-2"></i>Top 4 Customers by Outstanding Value (IDR)`;
                createHorizontalBarChart('chartTopCustomersValue', chartData.top_customers_value_idr, 'total_value',
                    'Total Outstanding', {
                ...
                if (topValueTitle) topValueTitle.innerHTML =
                    `<i class="fas fa-crown me-2"></i>Top 4 Customers by Outstanding Value (USD)`;
                createHorizontalBarChart('chartTopCustomersValue', chartData.top_customers_value_usd, 'total_value',
                    'Total Outstanding', {
                        bg: 'rgba(13, 110, 253, 0.6)',
                        border: 'rgba(13, 110, 253, 1)'
                    }, 'USD');
            }
            createHorizontalBarChart('chartTopOverdueCustomers', chartData.top_customers_overdue, 'overdue_count',
                'Jumlah PO Terlambat', {
