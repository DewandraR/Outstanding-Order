...
<div class="d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center mb-3 gap-3">
    <div>
        ...
        <p class="text-muted mb-0">Monitoring Sales Orders Ready for Shipment</p>
        @else
...
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="card yz-kpi-card h-100 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="ms-3">
                    <p class="mb-1 text-muted">Value Ready to Ship (USD)</p>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card yz-kpi-card h-100 shadow-sm">
            <div class="card-body d-flex align-items-center">
                ...
                <div class="ms-3">
                    <p class="mb-1 text-muted">Value Ready to Ship (IDR)</p>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card yz-kpi-card card-highlight-info h-100 shadow-sm">
            <div class="card-body d-flex align-items-center">
                <div class="yz-kpi-icon bg-info-subtle text-info"><i class="fas fa-shipping-fast"></i></div>
                <div class="ms-3">
                    <p class="mb-1 text-muted">Value to Ship This Week</p>
    ...
    <div class="col-lg-7">
        <div class="card shadow-sm h-100 yz-chart-card">
            <div class="card-body d-flex flex-column">
                <h5 class="card-title"><i class="fas fa-chart-column me-2"></i>Value Ready to Ship vs Overdue by Location</h5>
                <hr class="mt-2">
...
<div class="row g-4 mb-4">
    <div class="col-12">
        <div class="card shadow-sm h-100 yz-chart-card">
            <div class="card-body d-flex flex-column">
                <h5 class="card-title text-primary-emphasis"><i class="fas fa-crown me-2"></i>Top 5 Customers by Value Awaiting Shipment</h5>
                <hr class="mt-2">
    ...
    (() => {
        ...
        <thead class="yz-header-item">
            <tr>
                ...
                <th style="min-width:80px">WHFG</th>                {{-- KOLOM BARU --}}
                <th style="min-width:100px">Net Price</th>          {{-- KOLOM BARU --}}
                ...
                rows.forEach(r => {
                    ...
                    <td>${parseFloat(r.KALAB).toLocaleString('id-ID')}</td>          {{-- DATA BARU --}}
                    <td>${formatCurrencyForTable(r.NETPR, r.WAERK)}</td>            {{-- DATA BARU --}}
                    ...
                    if (customerRow) {
                        ...
                        const interval = setInterval(() => {
                            ...
                            if (soRow) {
                                ...
                                // =============================================================
                                // == PERUBAHAN 1: Hapus .click() agar tidak membuka tabel 3 ==
                                // =============================================================
                                // soRow.click(); // <-- BARIS INI DIHAPUS/DIJADIKAN KOMENTAR
                                // =============================================================
            ...
            if (currentView === 'so') {
                ...
                if (ctxLocationStatus) {
                    ...
                    if (locationData.length === 0) {
                        ...
                        // Pastikan urutan label tetap rapi
                        ...
                        new Chart(ctxLocationStatus, {
                            ...
                            options: {
                                ...
                                plugins: {
                                    tooltip: {
                                        callbacks: {
                                            // format ke USD default saja untuk tampilan;
                                            // kalau mau, bisa diubah sesuai preferensi.
                                            label: (ctx) => {
