    ...
    <aside class="sidebar d-flex flex-column min-vh-100">
        ...
        <div class="flex-grow-1 d-flex flex-column overflow-auto">
            <ul class="sidebar-nav">
                    ...
                    <form action="{{ route('dashboard.search') }}" method="GET" class="sidebar-search-form">
                        <div class="input-group">
                            <input type="text"
                                   ...
                                   required
                                   value="{{ request('term') ?? request('search_term') ?? '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $isPoRoute ? '' : 'collapsed' }}"
                       href="#submenu-outstanding"
                       data-bs-toggle="collapse"
                       role="button"
                       aria-expanded="{{ $isPoRoute ? 'true' : 'false' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $isSoRoute ? '' : 'collapsed' }}"
                       href="#submenu-outstanding-so"
                       data-bs-toggle="collapse"
                       role="button"
                       aria-expanded="{{ $isSoRoute ? 'true' : 'false' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $isStockRoute ? '' : 'collapsed' }}"
                       href="#submenu-stock"
                       data-bs-toggle="collapse"
                       aria-expanded="{{ $isStockRoute ? 'true' : 'false' }}"
