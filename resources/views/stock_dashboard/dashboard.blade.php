...
@push('styles')
    <style>
        ...
        /* ========================================================= */
        /* START: STYLE UNTUK HEADER KONSISTENSI */
        /* ========================================================= */
        .yz-drill-down-label {
            white-space: nowrap;
        }
...
@section('content')
    ...
    @php
        ...
        // Helper untuk membuat URL terenkripsi ke Stock Report
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center mb-3 gap-3">
        <div>
            <h1 class="mb-0 fw-bolder text-primary">Stock Dashboard</h1>
            <p class="text-muted mb-0"><i class="fas fa-chart-line me-1"></i> Live Inventory Analysis as of
                {{ date('d F Y') }}</p>
        </div>

        {{-- MODIFIED LOCATION DROPDOWNS (Gaya Konsisten) --}}
        <div class="d-flex flex-wrap gap-2 justify-content-start justify-content-lg-end">
            <span class="d-flex align-items-center text-muted small fw-semibold me-2 yz-drill-down-label">Drill Down
                Report:</span>
            @foreach ($locations as $werks => $name)
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg">
                        <h6 class="dropdown-header text-uppercase small text-primary-emphasis">Stock Type -
                            {{ $name }}</h6>
                        <li>
                            {{-- Link ke Stock Report WHFG (type=whfg) --}}
                            <a class="dropdown-item" href="{{ $encStockReport($werks, 'whfg') }}">
                                <i class="fas fa-warehouse me-2 text-info"></i> WHFG
                            </a>
                        </li>
                        <li>
                            {{-- Link ke Stock Report Packing (FG) (type=fg) --}}
                            <a class="dropdown-item" href="{{ $encStockReport($werks, 'fg') }}">
            ...
            <div class="card shadow-sm yz-chart-card">
                <div class="card shadow-sm yz-chart-card">
                    <div class="card-body d-flex flex-column">
                        <h5 class="card-title text-primary-emphasis" data-help-key="stock.charts.most_stock_customers">
