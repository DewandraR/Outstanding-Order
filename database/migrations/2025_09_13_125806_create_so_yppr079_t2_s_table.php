<?php
// database/migrations/2025_09_13_000002_create_so_yppr079_t2_table.php
...
return new class extends Migration {
    ...
    {
        Schema::create('so_yppr079_t2', function (Blueprint $table) {
            $table->engine   = 'InnoDB';
            ...
            // Unique key sesuai dump: (IV_WERKS_PARAM, IV_AUART_PARAM, VBELN, POSNR)
            $table->unique(['IV_WERKS_PARAM', 'IV_AUART_PARAM', 'VBELN', 'POSNR'], 'uq_t2');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('so_yppr079_t2');
    }
};
