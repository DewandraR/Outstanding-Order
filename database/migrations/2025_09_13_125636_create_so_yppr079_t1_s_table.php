<?php
// database/migrations/2025_09_13_000001_create_so_yppr079_t1_table.php
...
return new class extends Migration {
    ...
    {
        Schema::create('so_yppr079_t1', function (Blueprint $table) {
            $table->engine   = 'InnoDB';
    ...
    {
        Schema::dropIfExists('so_yppr079_t1');
    }
};
